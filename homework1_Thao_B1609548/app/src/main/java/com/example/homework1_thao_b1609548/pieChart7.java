...
public class pieChart7 extends AppCompatActivity {
    ...
    private void setData7(int count, float range) {
        ...
        double tong2 = amount1 + amount2 + amount3 + amount4 +amount5+amount6+amount7;
        double[] yData2 = {amount1, amount2, amount3, amount4, amount5,amount6,amount7};
