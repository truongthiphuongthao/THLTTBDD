...
public class PieChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pieChartMp.setHoleRadius(52f);
        pieChartMp.setTransparentCircleRadius(55f);
            ...
            public void onClick(View v) {
                ...
                switch (vitri) {
                    case 2:
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent2 = new Intent(PieChartActivity.this, pieChart2.class);
                    ...
                    case 3:
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent3 = new Intent(PieChartActivity.this, pieChart3.class);
                    ...
                    case 4:
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent4 = new Intent(PieChartActivity.this, pieChart4.class);
                    ...
                    case 5:
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent5 = new Intent(PieChartActivity.this, pieChart5.class);
                    ...
                    case 6:
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent6 = new Intent(PieChartActivity.this, pieChart6.class);
                    ...
                    case 7:
                        ...
                        double tong3pt4567 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7;
                        ...
                        double tong34567 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7;
                        ...
                        Intent intent7 = new Intent(PieChartActivity.this, pieChart7.class);
                    ...
                    case 8:
                        ...
                        double tong3pt45678 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7 + amount8;
                        ...
                        double tong345678 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7 + amount8;
                        ...
                        pieChartMp.setVisibility(View.VISIBLE);
                        Intent intent8 = new Intent(PieChartActivity.this, pieChart8.class);
                    ...
                    case 9:
                        ...
                        double tong3pt456789 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7 + amount8 + amount9;
                        ...
                        double tong3456789 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7 + amount8 + amount9;
                        ...
                        pieChartMp.setVisibility(View.INVISIBLE);
                        Intent intent9 = new Intent(PieChartActivity.this, pieChart9.class);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PieChartActivity.this, "Lưu hình ảnh pie thành công", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void setData7(int count, float range) {
        ...
        for (int i = 0; i < count; i++) {
            yEntrys.add(new PieEntry((float) (yData7[i] / tong7) * 100, mParties[i % mParties.length]));
        }
        PieDataSet dataSet = new PieDataSet(yEntrys, null);
        dataSet.setSliceSpace(3f);
        dataSet.setIconsOffset(new MPPointF(0, 40));
    ...
    private void setData9(int count, float range) {
        ...
        for (int i = 0; i < count; i++) {
            yEntrys.add(new PieEntry((float) (yData9[i] / tong9) * 100, mParties[i % mParties.length]));
        }
        PieDataSet dataSet = new PieDataSet(yEntrys, null);
        dataSet.setSliceSpace(3f);
        dataSet.setIconsOffset(new MPPointF(0, 40));
    ...
    class MpAndroidChart implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0,View arg1,int arg2,long arg3) {
            ...
            switch (arg2) {
                case 0:
                    ...
                    Toast.makeText(PieChartActivity.this, "Xin vui lòng chọn số phần tử từ 2 đến 9", Toast.LENGTH_LONG).show();
                    break;
                case 1:
                    pieChartMp.setVisibility(View.INVISIBLE);
                    tvTotal.setText("0");
